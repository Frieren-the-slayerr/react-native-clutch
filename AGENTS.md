...
We are building a Mobile Mechanic AI mobile app using Expo.

The app allows should be similar to Facebook and Doordash execpt its for getting a mobile mechanic to fix your vechicle , the mechanic side should allow them to see jobs and postings for vechicles:

- video-based AI
- audio messages
- chat-based AI infomation about the job
- vocabulary review
- local XP and lesson completion with levels for more and more jobs completed
- language selection
- beautiful mobile-first UI inspired by Facebook and Doordash  apps

This is primarily a Mobile App. The goal is to teach developers how to build a modern AI-powered Expo app feature by feature.
